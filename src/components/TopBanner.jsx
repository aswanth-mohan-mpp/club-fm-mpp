...
export default function TopBanner() {
  return (
    ...
    >
      ...
      <div className="absolute top-48 left-4 flex flex-col gap-1">
        <button className="flex justify-center items-center cursor-pointer focus:outline-none bg-dark-gray p-1">
      ...
      <div className="absolute -bottom-28 left-0 w-full z-30 flex justify-center pointer-events-none">
        <img src={wave} alt="wave" className="w-full max-w-5xl" />
      </div>
    </section>
  );
}
